# CarrierConnect360 — cleaner header logo
...
## What changed
The header logo was too small/cramped (the tiny "FLEET MANAGEMENT SYSTEM" tagline
was unreadable). Fixed:
- The header now uses just the shield + "CarrierConnect360" wordmark (tagline
  trimmed off -- it was too small to read in a header anyway).
- Sized up so it has proper presence in the nav bar.
This applies everywhere the logo appears (landing, login, signup, app sidebar,
driver portal). The FULL logo with the tagline + feature icons is still saved as
logo_full.png for wide banner use.

## Includes everything to date
Cleaner CarrierConnect360 header logo, logo everywhere, light landing page,
