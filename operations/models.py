...
class Company(models.Model):
    ...
    dba_name = models.CharField("DBA / doing-business-as name", max_length=120, blank=True)
    state_code = models.CharField("State (2-letter)", max_length=2, blank=True)
    state_tax_no = models.CharField("State tax / payer state no.", max_length=30, blank=True)
