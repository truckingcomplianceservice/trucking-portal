...
urlpatterns = [
    ...
    path("app/driver-map/", views.driver_map, name="driver_map"),
    path("app/driver-map/data/", views.driver_map_data, name="driver_map_data"),
    ...
    path("app/ifta/auto/", views.ifta_auto, name="ifta_auto"),
    path("app/ifta/per-truck/", views.ifta_per_truck, name="ifta_per_truck"),
    ...
    path("app/loads/<int:pk>/photo/add/", views.load_photo_add, name="load_photo_add"),
    path("app/loads/<int:pk>/photo/<int:photo_pk>/remove/", views.load_photo_remove, name="load_photo_remove"),
    ...
    path("app/brokers/<int:pk>/", views.broker_detail, name="broker_detail"),
    path("app/brokers/<int:pk>/agent/add/", views.broker_agent_add, name="broker_agent_add"),
    path("app/brokers/<int:pk>/agent/<int:agent_pk>/remove/", views.broker_agent_remove, name="broker_agent_remove"),
    ...
    path("app/accounting/expense/<int:pk>/check/", views.expense_check, name="expense_check"),
    path("app/accounting/expense/<int:pk>/check/nudge/", views.expense_check_nudge, name="expense_check_nudge"),
